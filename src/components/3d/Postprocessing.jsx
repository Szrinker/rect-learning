    ...
    <>
      ...
      >
        ...
        <SSAO
          ...
          samples={23} // amount of samples per pixel (shouldn't be a multiple of the ring count)
          ...
          luminanceInfluence={0.4} // how much the luminance of the scene influences the ambient occlusion
